...
@Component({
  selector: 'app-change-table4',
  templateUrl: './change-table4.component.html',
  styleUrls: ['./change-table4.component.css']
})
export class ChangeTable4Component implements OnInit {
  ...
  public chackTable1: boolean = false;
  ...
  chang_table(numTable, template) {
    ...
    var changFrom :number = numTable ;
    var chang : boolean = false ;
    this.OrderedFood = true;
    this.crudService.chackOrder(this.OrderedFood, this.numberTable);
    this.crudService.chackOrder(chang, changFrom);
    // console.log(numTable)
